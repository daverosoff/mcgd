...
Then $\Delta f = f(x,y) - f(a,b) \approx L(x,y) - L(a, b) \approx f_x(a,b)\Delta x + f_y(a,b) \Delta y$, at least when $dx$ and $dy$ are small.

It is common to write $dx = \Delta x$, $dy = \Delta y$, $df = L(x,y) - L(a,b) = f_x(a,b) dx + f_y(a,b) dy$. Thus we have $\Delta f \approx df$, a compact representation of the idea of the linearization. 
