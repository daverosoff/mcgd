...
NotebookDataLength[     80307,       1594]
NotebookOptionsPosition[     53369,       1015]
NotebookOutlinePosition[     79626,       1576]
CellTagsIndexPosition[     79515,       1570]
WindowTitle->Visualizing the Gradient Vector
WindowFrame->Normal*)
...
Cell["Visualizing the Gradient Vector", "DemoTitle",
 CellID->700863240],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`fff$$ = 
    1, $CellContext`options$$ = {$CellContext`gradient}, $CellContext`pt$$ = {
    1, 0}, Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`options$$], {$CellContext`gradient}, 
       ""}, {$CellContext`gradient -> Style[" \[Del]f", 
         RGBColor[1, 0, 0]], $CellContext`neggradient -> Style[" -\[Del]f", 
         RGBColor[0, 0, 1]], $CellContext`normalize -> 
       " normalize          ", $CellContext`format -> 
       Style[" large format", 10], $CellContext`label -> 
       Style[" show function", 10]}}, {{
       Hold[$CellContext`fff$$], 1, "function"}, {
      1 -> " maximum", 2 -> " minimum", 3 -> " linear", 4 -> " saddle 1", 5 -> 
       " saddle 2", 6 -> " example 1", 7 -> " example 2"}}, {{
       Hold[$CellContext`pt$$], {1, 0}, "location"}, {-3, -3}, {3, 3}}}, 
    Typeset`size$$ = {380., {206., 211.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    False, $CellContext`options$74917$$ = 0, $CellContext`fff$74918$$ = 
    0, $CellContext`pt$74919$$ = {0, 0}}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`fff$$ = 
        1, $CellContext`options$$ = {$CellContext`gradient}, \
$CellContext`pt$$ = {1, 0}}, "ControllerVariables" :> {
        Hold[$CellContext`options$$, $CellContext`options$74917$$, 0], 
        Hold[$CellContext`fff$$, $CellContext`fff$74918$$, 0], 
        Hold[$CellContext`pt$$, $CellContext`pt$74919$$, {0, 0}]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      DynamicModule[{$CellContext`grad, $CellContext`unitgrad, \
$CellContext`function, $CellContext`buttonText, \
$CellContext`functionButtons}, $CellContext`function[
           Pattern[$CellContext`x, 
            Blank[]], 
           Pattern[$CellContext`y, 
            Blank[]]] := {
          5 - $CellContext`x^2/
           2 - $CellContext`y^2, $CellContext`x^2/2 + $CellContext`y^2, 1 - 
           2 $CellContext`x + $CellContext`y, $CellContext`x^2/
            2 - $CellContext`y^2, (-$CellContext`x^2)/2 + $CellContext`y^2, 
           Sin[
           Sin[$CellContext`y] + 
            Sin[$CellContext`x]], $CellContext`x $CellContext`y 
           E^((-0.4) ($CellContext`x^2 + $CellContext`y^2))}; \
$CellContext`buttonText = {
          " maximum", " minimum", " linear", " laddle 1", " saddle 2", 
           " example 1", " example 2"}; $CellContext`functionButtons = 
         Map[Part[#, 1] -> Part[#, 2]& , 
           Transpose[{
             Range[
              
              Length[$CellContext`buttonText]], $CellContext`buttonText}]]; \
$CellContext`grad = D[
           Part[
            $CellContext`function[$CellContext`x, $CellContext`y], \
$CellContext`fff$$], {{$CellContext`x, $CellContext`y}}]; \
$CellContext`unitgrad = $CellContext`grad/
          Dot[$CellContext`grad, $CellContext`grad]^Rational[1, 2]; Deploy[
          Show[{
            ContourPlot[
             Part[
              $CellContext`function[$CellContext`x, $CellContext`y], \
$CellContext`fff$$], {$CellContext`x, -3, 3}, {$CellContext`y, -3, 3}, 
             Contours -> 10], 
            Graphics[{Red, 
              If[
               MemberQ[$CellContext`options$$, $CellContext`gradient], 
               If[
                And[
                 MemberQ[$CellContext`options$$, $CellContext`normalize], 
                 Dynamic[
                   
                   ReplaceAll[$CellContext`grad, {$CellContext`x -> 
                    Part[$CellContext`pt$$, 1], $CellContext`y -> 
                    Part[$CellContext`pt$$, 2]}]] =!= {0, 0}], 
                Dynamic[
                 
                 Arrow[{$CellContext`pt$$, $CellContext`pt$$ + 
                   ReplaceAll[$CellContext`unitgrad, {$CellContext`x -> 
                    Part[$CellContext`pt$$, 1], $CellContext`y -> 
                ...
                Dynamic[
                 Tooltip[
                  ...
                  Style[
                   ...
                   ReplaceAll[$CellContext`grad, {$CellContext`x -> 
                    Part[$CellContext`pt$$, 1], $CellContext`y -> 
                    Part[$CellContext`pt$$, 2]}], Red]]], Null], Red], 
              If[
               MemberQ[$CellContext`options$$, $CellContext`normalize], {
               Black, 
                Dynamic[
                 Circle[$CellContext`pt$$, 1]]}, Blue], Blue, 
              If[
               MemberQ[$CellContext`options$$, $CellContext`neggradient], 
               If[
                And[
                 MemberQ[$CellContext`options$$, $CellContext`normalize], 
                 Dynamic[
                ...
                Dynamic[
                 Tooltip[
                  ...
                  Style[
                   ...
                   ReplaceAll[-$CellContext`grad, {$CellContext`x -> 
                    Part[$CellContext`pt$$, 1], $CellContext`y -> 
                    Part[$CellContext`pt$$, 2]}], Blue]]]], Blue], 
              Tooltip[
               Locator[
                Dynamic[$CellContext`pt$$]], 
               Dynamic[$CellContext`pt$$]]}]}, ImageSize -> If[
             MemberQ[$CellContext`options$$, $CellContext`format], 500, 380], 
           PlotLabel -> If[
             MemberQ[$CellContext`options$$, $CellContext`label], 
             StringJoin[
              ToString[
              ...
              ToString[
               Part[
                $CellContext`function[$CellContext`x, $CellContext`y], \
$CellContext`fff$$], TraditionalForm]], 
             Column[{" "}, ItemSize -> {Automatic, 2.75}]]]]], 
      "Specifications" :> {{{$CellContext`options$$, {$CellContext`gradient}, 
          ""}, {$CellContext`gradient -> Style[" \[Del]f", 
            RGBColor[1, 0, 0]], $CellContext`neggradient -> Style[" -\[Del]f", 
            RGBColor[0, 0, 1]], $CellContext`normalize -> 
          " normalize          ", $CellContext`format -> 
          Style[" large format", 10], $CellContext`label -> 
          Style[" show function", 10]}}, {{$CellContext`fff$$, 1, 
          "function"}, {
         1 -> " maximum", 2 -> " minimum", 3 -> " linear", 4 -> " saddle 1", 
          5 -> " saddle 2", 6 -> " example 1", 7 -> " example 2"}, 
         ControlType -> 
         Setter}, {{$CellContext`pt$$, {1, 0}, "location"}, {-3, -3}, {3, 3}, 
         ImageSize -> Dynamic[
           If[
            MemberQ[$CellContext`options$$, $CellContext`format], Medium, 
            Tiny]]}}, 
      "Options" :> {
       ControlType -> {CheckboxBar, Setter, Slider2D}, 
        ControlPlacement -> {Top, Top, Left}, AutorunSequencing -> {1, 2, 3}},
       "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{510., {257., 262.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>({
      Clear[$CellContext`x, $CellContext`y]; $CellContext`buttonText = {
         " maximum", " minimum", " linear", " saddle 1", " saddle 2", 
          " example 1", " example 2"}; $CellContext`functionButtons = 
        Map[Part[#, 1] -> Part[#, 2]& , 
          Transpose[{
            Range[
...
Cell[TextData[{
 ...
 " is superimposed on a contour plot of the function ",
 Cell[BoxData[
  FormBox[
   RowBox[{"f", "(", 
    RowBox[{"x", ",", "y"}], ")"}], TraditionalForm]], "InlineMath"],
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{"(", 
    RowBox[{"a", ",", "b"}], ")"}], TraditionalForm]], "InlineMath"],
 " around the plot region, you can see how the magnitude and direction of the \
gradient vector change. You can normalize the gradient vector to focus only \
on its direction, which is particularly useful where its magnitude is very \
small."
}], "ManipulateCaption",
 CellID->120037462],

Cell[TextData[{
 "Coordinates of the point in the plot region can be viewed by hovering the \
mouse over the point. ",
 "Components of the vectors ",
 Cell[BoxData[
  FormBox[
   RowBox[{"\[Del]", "f"}], TraditionalForm]], "InlineMath"],
 " and ",
 Cell[BoxData[
  FormBox[
   RowBox[{"-", 
    RowBox[{"\[Del]", "f"}]}], TraditionalForm]], "InlineMath"],
 " can",
 " viewed by hovering the mouse over the vectors."
}], "ManipulateCaption",
 CellID->52171470],
...
VisualizingTheGradientVector&version=0025"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/VisualizingTheGradientVector/\
VisualizingTheGradientVector-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 ...
 ButtonBox["http://demonstrations.wolfram.com/VisualizingTheGradientVector/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/VisualizingTheGradientVector/"], 
    None},
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[45490, 829, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[45751, 838, 719, 18, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[52547, 990, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 79230, 1559},
 {"Copyright", 79424, 1564}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[595, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34926, 590, 72, 1, 70, "DemoTitle",
 CellID->700863240],
Cell[35001, 593, 9095, 188, 70, "Output",
 CellID->151590800],
Cell[44099, 783, 926, 27, 70, "ManipulateCaption",
 CellID->120037462],
Cell[45028, 812, 459, 15, 70, "ManipulateCaption",
 CellID->52171470],
Cell[45490, 829, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[45751, 838, 719, 18, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[46473, 858, 4823, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[51299, 949, 45, 0, 70, "CitationSection"],
Cell[51347, 951, 852, 24, 70, "Citations"],
Cell[52202, 977, 342, 11, 70, "Author",
 CellID->1127484526],
Cell[52547, 990, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
...
(* NotebookSignature 5SqBSLdaKiaCtuQo#qlfxnpU *)
